120. Since the node modules are very large after the rar.file also (80 MB ) . So they are not uploaded on git hub .
...
First create the Api for the normal user then go to the othersections.



# STEP 3 :  CREATING the entity classes "1.User"  & "2.Roles" , then using the User_Roles class to maintain the many to many relationship.
...
But the Drive link contains the full project in the rar. file. Also whenever recovering the project. Read the instruction and tips that u have made during prepartion of project.
Projectuploadedonmydrive:https://drive.google.com/drive/folders/1oUOOZr5bP0dnDN7wMFZbJ0ikrixLvuNi?usp=sharing
Database name is : exam 
